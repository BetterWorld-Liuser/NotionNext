...
const BLOG = {
  AUTHOR: 'Liu', // 作者
  BIO: '一个普通的普通人', // 作者简介
  LINK: 'https://publish.liuzhengdong.top', // 网站地址
  KEYWORDS: '博客, 技术分享', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'd76acac1e43c46b5b8ef84da3a4e1354', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '735083049@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/BetterWorld-Liuser', // 你的github个人主页
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '8901847f4488da15bdeb517c77b82d2b', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '由NotionNext自动生成生成', // 站点描述，被notion中的页面描述覆盖
